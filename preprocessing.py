...
def data_check(df_name, path):
    ...
    ext_list  = [j_path(path,d) for d in data_list if d.endswith('EXT.bmp')]
...
def dataframe_creation(df, df_name, data_path, annot_path, resize):
    ...
    img_resize(clear_df, data_path=data_path, name = df_name+'_EXT_clear_2data_mode', \
               des_path=os.path.join(data_path,'EXT','resize'), resize=resize)
...
if __name__ == "__main__":
    ...
    # data_check(df_name='20201229',path='data/20201229')
    # df creation and preprocessing
    dataframe_creation(df='20201229_EXT.csv', df_name='20201229', data_path='data/20201229', \
                       annot_path='data/20201229/EXT', resize = (750,750))
